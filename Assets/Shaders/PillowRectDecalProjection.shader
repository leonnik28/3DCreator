Shader "Universal Render Pipeline/PillowRectDecalLit"
{
    Properties
    {
        ...
        _NoPrintCenterU ("No-Print Center U", Range(0,1)) = 0
        _NoPrintHalfU ("No-Print Half Width U", Range(0,0.5)) = 0
        _NoPrintAtEdges ("No-Print At Canvas Edges", Float) = 1
        _NoPrintCenterV ("No-Print Center V", Range(0,1)) = 0.5
        _NoPrintHalfV ("No-Print Half Width V", Range(0,0.5)) = 0
        _NoPrintAtEdgesV ("No-Print At Canvas Edges V", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                // Базовая проверка границ канваса
                ...
                if(isDecal)
                {
                    ...
                    // Зеркалирование (U/V)
                    if(_MirrorU > 0.5) localPos.x = -localPos.x;
                    if(_MirrorV > 0.5) localPos.y = -localPos.y;
